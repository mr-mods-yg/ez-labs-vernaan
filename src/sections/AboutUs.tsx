function AboutUs() {
    return (
        <div id="about-us" className="h-dvh flex flex-col md:flex-row snap-start items-center">
            <div className="w-9/10 md:w-1/2 flex flex-col justify-center text-center font-halant gap-5 md:gap-10 mt-20">
                <p className="text-2xl md:text-3xl lg:text-4xl">A montage of familiar faces and names.</p>
                <p className="text-lg md:text-xl lg:text-2xl lg:mx-30">Some stories come from the biggest names. Others begin with bold, rising voices.
                    We’ve been fortunate to walk alongside both - listening, creating, and building stories that matter.</p>

                <p className="flex justify-center">
                    <img src={"/assets/about_us_projects.svg"} className="size-32 md:size-50 lg:size-64  -mr-10 md:-mr-25" />
                    <img src={"/assets/about_us_happy_clients.svg"} className="size-32 md:size-50 lg:size-64 -mr-10 md:-mr-25" />
                    <img src={"/assets/about_us_experts_team.svg"} className="size-32 md:size-50 lg:size-64 md:-mr-2" />
                </p>
            </div>
            <div className="w-9/10 md:w-1/2 flex flex-col h-full justify-between items-center text-center md:pt-18">
                <div className="font-island-moments text-3xl sm:text-4xl md:text-5xl lg:text-[60px] md:mx-10">
